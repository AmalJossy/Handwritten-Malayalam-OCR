...
def getLabels():
    ...
    model=load_model('/home/hashrin/project/final/saved model/finalmodel1.h5')
    labels=['അ','ഖ','മ്മ','മ്ല','യ്യ','ല്ല','വ്വ','ശ്ശ','ശ്ല','ശ്ച','ഷ്ട','സ്ല','ഗ','സ്സ','സ്റ്റ','സ്ഥ','ഹ്മ','ഹ്ന','ഹ്ല','ള്ള','റ്റ','ൻ','ഘ','ൽ','ർ','ൾ','ൺ','ന്ധ','ങ','ച','ഛ','ജ','ഝ','ഞ','ട','ആ','ം','ഡ','ഢ','ണ','ത','ഥ','ദ','ധ','ന','പ','ഇ','ഫ','ബ','ഭ','മ','യ','ര','ല','വ','ശ','ഷ','ഉ','സ','ഹ','ള','ഴ','റ','ാ','ി','ീ','ു','ൂ','ഋ','ൃ','െ','േ','ൗ','്','്യ','്ര','്വ','ക്ക','ക്ല','എ','ക്ഷ','ക്ത','ഗ്ഗ','ഗ്ല','ഗ്ന','ഗ്മ','ങ്ക','ങ്ങ','ച്ച','ച്ഛ','ഏ','ജ്ജ','ജ്ഞ','ഞ്ച','ഞ്ഞ','ട്ട','ഡ്ഡ','ണ്ട','ണ്ഡ','ണ്മ','ണ്ണ','ഒ','ത്ത','ത്ഥ','ത്ഭ','ത്സ','ത്മ','ദ്ദ','ദ്ധ','ന്റ','ന്ത','ന്ദ','ക','ന്ന','ന്മ','ന്ഥ','പ്പ','പ്ല','ബ്ബ','ബ്ല','ബ്ദ','മ്പ']
